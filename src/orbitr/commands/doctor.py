"""orbitr doctor — connectivity and configuration health checks."""
...
def doctor(ctx: typer.Context) -> None:
    ...
    table = Table(title="orbitr doctor", show_header=True, header_style="bold")
    ...
    if any_fail:
        ...
        console.print("\n[green]All checks passed.[/green] orbitr is ready to use.")
    raise typer.Exit()
