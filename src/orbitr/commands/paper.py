"""orbitr paper / orbitr cite — fetch a paper or its citations by ID."""
...
def paper(
    ...
    Examples:
      ...
      orbitr paper 1706.03762

      orbitr paper 10.18653/v1/2020.acl-main.196
...
async def fetch_paper(paper_id: str, *, cfg, no_cache: bool = False) -> Paper:
    ...
    Shared helper used by ``orbitr paper``, ``orbitr zotero add``, etc.
...
def cite(
    ...
    Examples:
      ...
      orbitr cite 1706.03762 --limit 50 --format json
    """
    cfg = ctx.obj.config
    effective_fmt = effective_format(fmt, cfg.format)
