...
orbitr accepts a simple ``field:value`` syntax in the query string:

    orbitr search "title:transformers author:Vaswani"
    orbitr search "BERT" --title "contrastive learning" --author "Gao"
...
# Mapping from orbitr field names to arXiv field prefix codes.
